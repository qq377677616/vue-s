...
export default {
  ...
  data() {
    return {
      pageTitle: "echart图表--中国地图",
      myEchart: null//实例
    }
  },
  mounted() {
    console.log('document.getElementsByTagName("body")', document.getElementsByTagName("body")[0])
    document.getElementById("app").style.margin = '0'
    document.getElementsByTagName("body")[0].style.setProperty('background', '#060D39', 'important')
    this.myEchart = echarts.init(this.$refs.myEchart);
    console.log("echarts", echarts)
    console.log("this.myEchart", this.myEchart)
    this.mapInit()
    this.addScatter()
  },
  methods: {
...
<style scoped>
  ...
  .wrapper,.map-container{width: 100vw;height: calc(100vh - 1.92rem);background: #060D39;}
</style>