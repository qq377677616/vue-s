...
function addPage(page, book, imgUrl) {
    ...
    if (book.turn('addPage', element, page)) {
        ...
        // Load the page
        loadPage(page, element, imgUrl);
    }

}

function loadPage(page, pageElement, imgUrl) {
console.log("imgUrl", imgUrl)
    ...
    // Load the page
    // img.attr('src', imgUrl + page + '.png');
    img.attr('src', typeof imgUrl != 'string' ? imgUrl[page - 1] : (getPublicUrl(imgUrl).publicUrl + page + '.' + getPublicUrl(imgUrl).format));
...
function loadLargePage(page, pageElement) {
    ...
    // Loadnew page
    img.attr('src', 'https://img.vrupup.com/web/szq/book/pages/' + page + '-large.png');
}
